...
export const SkillSection =() =>{
    ...
    return (
        <section id='skill' className="lg:h-screen text-gray-600 body-font">
            <div className="pt-20 w-full h-full wrapper" id = "wrapper-skill">
                <h1 className="flex items-center px-6 lg:w-3/5 text-5xl text-gray-800 font-serif">Skill</h1>
                <div className="h-full grid gap-2 row-gap-3 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 py-10 px-6 mx-auto">
                    <div className="flex items-center lg:w-4/5 md:w-4/5 sm:w-4/5 mx-auto border-b pb-10 mb-10 border-gray-400 sm:flex-row flex-col">
                        ...
                        <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0 tracking-widest">
                            <h2 className="text-gray-900 text-xl title-font font-medium mb-2">フロントエンド</h2>
                    ...
                    <div className="flex items-center lg:w-4/5 md:w-4/5 sm:w-4/5 mx-auto border-b pb-10 mb-10 border-gray-400 sm:flex-row flex-col">
                        ...
                        <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0 tracking-widest">
                            <h2 className="text-gray-900 text-xl title-font font-medium mb-2">バックエンド</h2>
                    ...
                    <div className="flex items-center lg:w-4/5 md:w-4/5 sm:w-4/5 mx-auto border-b pb-10 mb-10 border-gray-400 sm:flex-row flex-col">
                        ...
                        <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0 tracking-widest">
                            <h2 className="text-gray-900 text-xl title-font font-medium mb-2">データベース</h2>
                    ...
                    <div className="flex items-center lg:w-4/5 md:w-4/5 sm:w-4/5 mx-auto border-b pb-10 mb-10 border-gray-400 sm:flex-row flex-col">
                        ...
                        <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0 tracking-widest">
                            <h2 className="text-gray-900 text-xl title-font font-medium mb-2">ツール</h2>
                    ...
                    <div className="flex items-center lg:w-4/5 md:w-4/5 sm:w-4/5 mx-auto border-b pb-10 mb-10 border-gray-400 sm:flex-row flex-col">
                        ...
                        <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0 tracking-widest">
                            <h2 className="text-gray-900 text-xl title-font font-medium mb-2">資格</h2>
